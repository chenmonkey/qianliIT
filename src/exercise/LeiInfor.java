...
public class LeiInfor {
public static void main(String args[]){
	Canlen calen=new Canlen();
	Class cs=calen.getClass();
	...
	System.out.println("Canlen类有如下成员变量:");
	for(int i=0;i<field.length;i++)
		System.out.println(field[i].toString());
	System.out.println("Canlen类有如下方法:");
	for(int i=0;i<method.length;i++)
		System.out.println(method[i].toString());
	System.out.println("Canlen类有如下构造方法:");
